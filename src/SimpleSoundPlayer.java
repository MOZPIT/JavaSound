...
/*
 * The SimpleSoundPlayer encapsulates a sound thta can be opened from the file system and later played.
 */
...
public class SimpleSoundPlayer {
	...
	public static void main(String[] args){
		//load a sound
		SimpleSoundPlayer sound = new SimpleSoundPlayer("sound/wave.wav");
